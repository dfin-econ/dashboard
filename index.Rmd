...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-G4G2HJ1Y2S"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-G4G2HJ1Y2S');
</script>
</head>   
...
dygraph(cbi_cats_xts) %>%
  dySeries("Other_retail", strokeWidth = 2, color = "#00a685") %>%
  dySeries("Accommodation", strokeWidth = 2, color = "#a3915e") %>%
  dySeries("Transport", strokeWidth = 2, color = "#004D44") %>%
  dySeries("Restaurants_dining", strokeWidth = 2, color = "#dbac00") %>%
  dySeries("Groceries_perishables", strokeWidth = 2, color = "#0090d4")
